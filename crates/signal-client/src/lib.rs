...
mod tests {
    ...
    async fn create_test_client(mock_server: &MockServer) -> SignalClient {
        SignalClient::new(mock_server.uri(), "+15555555555").unwrap()
    }
    ...
    async fn test_receive_messages() {
        ...
        Mock::given(method("GET"))
            .and(path("/v1/receive/+15555555555"))
    ...
    async fn test_send_message() {
        ...
        let client = create_test_client(&mock_server).await;
        let result = client.send("+14155551234", "Hello!").await;
    ...
    async fn test_get_account() {
        ...
        Mock::given(method("GET"))
            .and(path("/v1/accounts/+15555555555"))
    ...
    #[tokio::test]
    async fn test_phone_number_getter() {
        let mock_server = MockServer::start().await;
        let client = create_test_client(&mock_server).await;
        assert_eq!(client.phone_number(), "+15555555555");
    }
}
